...
const Navbar = () => {
    ...
    return (
        <div className='flex flex-row gap-2 justify-between w-screen items-center z-20  p-3  md:px-10 bg-slate-900 text-gray-400'>
            ...
            <div className={`nav -translate-y-72  duration-500 ${open && '-translate-y-0'} p-3 flex flex-col fixed top-10 left-0 bg-slate-900 gap-3 w-screen md:w-auto  md:static  md:flex-row `} >
                <a href="#">Home</a>
                <a href="#">About</a>
                <a href="#">Sermons</a>
                <a href="#">Gallery</a>
