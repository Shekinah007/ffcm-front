...
const Navbar = (): ReactElement => {
    ...
    return (
        <div className={`justify-center flex fixed w-screen flex-col md:flex-row  md:justify-between min-h-[40px] items-center z-20 px-3 md:p-2 duration-400 md:px-10 ${open ? "bg-gray-800/90 text-white" : "bg-black"} text-white border-b-2 border-yellow-500 `}>
