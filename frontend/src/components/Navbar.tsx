...
const Navbar = (): ReactElement => {
    ...
    return (
        <div className={`justify-center flex fixed w-screen flex-col md:flex-row  md:justify-between min-h-[40px] items-center z-20 px-3 md:p-2  md:px-10 ${open ? "bg-white/30" : "bg-black"} text-white border-b-2 border-white `}>
            ...
            <div className={`absolute top-50% left-3 w-11/12 flex flex-row items-center justify-between gap-2 duration-700 ${open && "hidden"} md:hidden`}>
