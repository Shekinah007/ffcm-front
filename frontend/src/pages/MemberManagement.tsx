...
export const UserComponent = ({ name, username }: any) => {
    return (
        <Link to={`/adminDashboard/memberProfile/${username}`} className="animate-rec card border-solid border-b-2 border-gray-300 w-full flex items-center gap-2 text-yellow-600 rounded-md p-2 px-2 text-lg md:text-xl font-semibold text-left">
            <AccountCircle />
...
const MemberManagement = ({ setPage }: any) => {
    ...
    return (
        <div className="entrance pt-24 md:pt-20 px-5 md:px-16 w-full min-h-screen">
