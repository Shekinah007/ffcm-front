...
const BulletinDetails = ({ userData }: any) => {
    return (
        <div className="pt-[100px] px-4 pb-8 min-h-screen font-semibold text-gray-700">
            <h2 className="text-2xl font-semibold">Thanks Giving!!</h2>
            <hr className="bg-gray-400 h-1 rounded-full mb-2" />
            {/* <img src={ } /> */}
            <div className="flex flex-col gap-4 indent-5">
                <img src={eventImg} alt="Stoty Image" className="rounded-lg"></img>
